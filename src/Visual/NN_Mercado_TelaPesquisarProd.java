...
public final class NN_Mercado_TelaPesquisarProd extends javax.swing.JFrame {

    Connection con;
    PreparedStatement pst;
    ResultSet rs;

    public NN_Mercado_TelaPesquisarProd() throws ClassNotFoundException {
        initComponents();
    ...
    private void ButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonExcluirActionPerformed
        try {
            ...
            Logger.getLogger(NN_Mercado_TelaPesquisarProd.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void ButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonEditarActionPerformed
        ...
        NN_mercado_TelaEdicaoProd enviaTexto;
        enviaTexto = null;
        try {
            enviaTexto = new NN_mercado_TelaEdicaoProd();
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(NN_Mercado_TelaPesquisarProd.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NN_Mercado_TelaPesquisarProd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
