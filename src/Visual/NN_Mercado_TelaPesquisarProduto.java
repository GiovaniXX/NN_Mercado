...
public final class NN_Mercado_TelaPesquisarProduto extends javax.swing.JFrame {
    ...
    public NN_Mercado_TelaPesquisarProduto() throws ClassNotFoundException {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NN_Mercado_TelaPesquisarProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
